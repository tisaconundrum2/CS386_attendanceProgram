...
<div class="form">
  ...
  <button class="button button-block">CS 249</button>
  <button class="button button-block">ENG 305</button>
  <button class="button button-block">PHI 104</button>

<button class="button button-block">NUTS 101</button>
